...
/*! Noatice v0.2.2 * https://noatice.com/ * Copyright (c) 2020-2025 Robert Noakes * License: GNU General Public License v2 or later */
...
if (typeof $.noatice === 'undefined')
	{
				...
				$.fn.extend(
		{
			"noatice_message": function (message)
			{
				...
				.each(function ()
				{
					$('<div class="noatice-message" />').html(message).noatice_sanitize_html().appendTo($(this));
				});
			},

			"noatice_sanitize_html": function ()
			{
				var wrapper = $('<div />').append(this);

				wrapper.find('animate, applet, audio, base, bgsound, body, embed, event-source, frame, head, html, iframe, meta, object, script, set, style, title, video, vmlframe, x, xml, xss, [action*="pt:"], [background*="pt:"], [data*="ta:"], [dynsrc*="pt:"], [formaction], [href*="ta:"], [href*="pt:"], [lowsrc*="pt:"], [onbeforeunload], [onblur], [onerror], [onfocus], [oninput], [onkeydown], [onkeypress], [onkeyup], [onload], [onmouseenter], [onmouseleave], [onmousemove], [onmouseout], [onmouseover], [onmouseup], [onmousewheel], [onpagehide], [onpageshow], [onpopstate], [onpropertychange], [onreadystatechange], [onresize], [onscroll], [onstart], [onunload], [poster*="pt:"], [size*="pt:"], [src*="ta:"], [src*="pt:"], [style*="behavior"], [style*="expression"], [style*="pt:"], [value*="pt:"], [xlink\\:href*="pt:"]').remove();
				...
				$.extend(METHODS,
		{
			"enter": function ()
			{
				...
				)
				{
					...
					{
						PLUGIN.wrapper.noatice_sanitize_html().appendTo(PLUGIN.body);
					}
							...
							if (noatice.length === 0)
					{
								...
								if (options.dismissable)
						{
							...
							)
							{
								...
								{
									var current = $(this),
										timeout = current.data(PLUGIN.dismiss);
						...
						else
						{
							options.delay = 0;
								...
								setTimeout(function ()
						{
							noatice.noatice_sanitize_html().prependTo(PLUGIN.wrapper)
							.animate(
							{
								"margin-left": '0px'
							},
			...
			"tooltips": function (elements)
			{
						...
						if (elements.length > 0)
				{
					...
					.on('focus mouseenter', function ()
					{
						...
						{
							tooltip.noatice_sanitize_html().appendTo(PLUGIN.body);
						}
